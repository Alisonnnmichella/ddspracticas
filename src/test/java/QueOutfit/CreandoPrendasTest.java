...
public class CreandoPrendasTest {
    ...
    public void pruebaListas(){
        ...
        Set<List<Prenda>> result=sugerencia.combinaciones(guardarropa);

        ArrayList <Prenda> comb1=new ArrayList<Prenda>();
        ArrayList <Prenda> comb2=new ArrayList<Prenda>();
        ArrayList <Prenda> comb3=new ArrayList<Prenda>();
        ArrayList <Prenda> comb4=new ArrayList<Prenda>();
        ArrayList <Prenda> comb5=new ArrayList<Prenda>();
        ArrayList <Prenda> comb6=new ArrayList<Prenda>();
        ArrayList <Prenda> comb7=new ArrayList<Prenda>();
        ArrayList <Prenda> comb8=new ArrayList<Prenda>();
